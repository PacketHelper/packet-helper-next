      ...
      <v-app-bar dark app>
        <v-container>
          <v-toolbar>
            ...
            > -->
            <v-spacer></v-spacer>
            <v-btn text disabled>"Craft packets before, packets craft you" 🐱‍👤 </v-btn>
            <v-dialog v-model="dialog" width="500">
              ...
              <v-card>
                ...
                <v-card-text>
                  The application has been prepared to facilitate the work of all those
                  who work with internet packages on a daily basis. If you program in P4
                  Lang at your work, use the PTF framework or you don't know what
                  happened to your package during the laboratories at the university.
                  <br /><br />Find us at:<br />
        ...
        <v-container fluid>
          <v-container>
            <v-alert icon="mdi-shield-lock-outline" prominent text type="info">
              <strong>Legacy version</strong> of the PacketHelper is available at
